...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    return <div className="h-9 w-[132px] rounded-xl bg-white/5 ring-1 ring-white/10 animate-pulse" />;
  }

  const current = theme === "system" ? (systemTheme ?? resolvedTheme ?? "dark") : theme;
  ...
  const active = "bg-[#cbb797]/15 text-[#cbb797] ring-[#cbb797]/30 shadow-[0_0_12px_#cbb79733]";
  const inactive = "text-white/70 hover:text-white hover:bg-white/5 ring-white/10";
